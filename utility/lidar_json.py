...
# --- Configuration ---
SERIAL_PORT = '/dev/ttyUSB0'  # Common for USB adapters on Jetson
BAUD_RATE = 115200            # Default SF000/B baud rate
OUTPUT_DIR = 'output'         # Folder for sensor output files
LIDAR_JSON = os.path.join(OUTPUT_DIR, 'lidar.json')
...
def update_lidar_json(distance_cm, out_of_range):
    """Create or update lidar.json with the latest distance reading."""
    os.makedirs(OUTPUT_DIR, exist_ok=True)
    data = {
        "distance_cm": None if out_of_range else distance_cm,
    ...
    try:
        ...
        while True:
            ...
            if res:
                ...
                out_of_range = distance_cm == -100  # Out of range indicator [cite: 272]
                ...
                update_lidar_json(distance_cm, out_of_range)
